...
HD_PWD='C:/dev/FPGA/countFSM/countFSM.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log countFSM_tb.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source countFSM_tb.tcl
